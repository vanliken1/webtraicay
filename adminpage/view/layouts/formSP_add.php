                ...
                <div class="row g-4 d-flex justify-content-center">
                    <div class="col-sm-12 col-xl-6">
                        <div class="bg-light rounded h-100 p-4">
                            ...
                            <form action="sanpham_store.php" method="POST" enctype="multipart/form-data">
                                
                                <div class="row mb-3">
                                    <label for="exampleInput1" class="form-label">Mã sản phẩm</label>
                                    <div class="col-sm-12">
                                        <input type="text" class="form-control" id="exampleInput1" name="idsanpham" required>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-12">
                                        <input type="text" class="form-control" id="exampleInput2" name="tensanpham" required>
                                        
                                    </div>
                                </div>

                                <textarea name="mota" id="mota" id="" cols="30" rows="10" >  </textarea> <br>
                                <script>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-5">
                                        <input type="text" class="form-control" id="exampleInput2" name="gia" required>
